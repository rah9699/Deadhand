defmodule DeadhandWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DeadhandWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DeadhandWeb.Gettext, "errors", msg, opts)
    end
  end
